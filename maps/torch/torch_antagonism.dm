...
/datum/antagonist/ert
	...
	leader_welcome_text = "As leader of the Emergency Response Team, you are part of the 4th Fleet, and are there with the intention of restoring normal operation to the vessel or the safe evacuation of crew and passengers. You should, to this effect, aid the Admiral or ranking officer aboard in their endeavours to achieve this."
