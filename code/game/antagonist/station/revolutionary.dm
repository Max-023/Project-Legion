...
/datum/antagonist/revolutionary
	...
	restricted_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/stormcom, /datum/job/chief_engineer, /datum/job/rd, /datum/job/cmo, /datum/job/lawyer)
	protected_jobs = list(/datum/job/storm, /datum/job/riotcommander, /datum/job/inquisitor)
